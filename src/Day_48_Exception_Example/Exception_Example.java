...
public class Exception_Example {
 /*   public static void main(String[] args) {
        ...
        int[] array10= {2,5,1,1,45,10,89,150};
        System.out.println(maxNumberArray(array10));
    }*/

    public static int maxNumberArray(int[] arr){         //arraydaki en yüksek sayıyı getirme metodu..
