...
public class ManavMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Math.round(toplamFiyat));          //round yuvarlama yapar en yakın sayıya..
       ...
       // System.out.println(result);
        System.out.println(Integer.parseInt("1") + 5);            //icerdeki veriyi stringden integer a cevirir..
