...
public class Cat {
    ...
    //Cat adında bir class oluşturun, eyeColor, breed, isFat, isPet
// adında fields tanımlayın, constructors (5 adet),
// sleep, food, run metodları oluşturarak main metodunda bu class dan bir obje oluşturun.
